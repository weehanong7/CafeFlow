...
declare function BottomTabNavigator({ id, initialRouteName, backBehavior, children, layout, screenListeners, screenOptions, UNSTABLE_getStateForRouteNamesChange, ...rest }: Props): import("react/jsx-runtime").JSX.Element;
